...
-type hackney_host_measurements() ::
    connect_error
    | connect_time
    | connect_timeout
    | nb_requests
    | request_time
    | response_time.
-type hackney_pool_measurements() ::
    free_count | in_use_count | no_socket | queue_count | take_rate.
...
-type hackney_host_metrics() ::
    ...
    | new_connection
    | reuse_connection.
-type hackney_pool_metrics() ::
    take_rate | no_socket | in_use_count | free_count | queue_count.
